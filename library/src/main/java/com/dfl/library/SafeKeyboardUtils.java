...
/**
* @author daifalin
* @date 2019/3/11 3:20 PM
* @ClassName SafeKeyboardUtils.java
* @Description
*/


public class SafeKeyboardUtils {

    private static final String TAG = "SafeKeyboardUtils";
    ...
    private int keyboardResId = R.id.safeKeyboardLetter;
    ...
    public SafeKeyboardUtils(Context mContext, LinearLayout layout, EditText mEditText, int id) {
        this.mContext = mContext;
        this.layout = layout;
        this.mEditText = mEditText;
        this.keyboardContainerResId = id;
        this.delDrawable = mContext.getResources().getDrawable(R.drawable.icon_del);
        this.lowDrawable = mContext.getResources().getDrawable(R.drawable.icon_capital_default);
        this.upDrawable = mContext.getResources().getDrawable(R.drawable.icon_capital_selected);
        initKeyboard();
        initAnimation();
        addListeners();
    }
    ...
    private void initKeyboard() {
        ...
        TextView done = keyContainer.findViewById(R.id.keyboardDone);
